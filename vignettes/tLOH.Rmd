...
```{r marginalCalculations, eval=TRUE, message='hide'}
setwd('../inst/extdata/')
 df <- tLOHCalc('.',"Example")
...
list of three plots, which you can visualize individually:

```{r plotting1, eval=TRUE, message='hide'}
savePlots <- plotLOH(df,"Example")

savePlots[[1]] ## Allele Fraction Plot

savePlots[[2]] ## Line plot of aggregated Log10(1/K)

savePlots[[3]] ## Column plot of aggregated Log10(1/K)
```
