...
which will be the output of tLOHCalc, and sample name. Example output df from 
tLOHCalc is provided in an .rda file in /inst/extdata. The dataframe contains 
10436 rows and 20 columns. The column descriptions are as follows -
