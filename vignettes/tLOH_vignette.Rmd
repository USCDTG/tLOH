...
3. tLOH has two plotting functions, alleleFrequencyPlot() and aggregateCHRPlot. 
Both require the output dataframe from running tLOHCalc, and a same name for 
the plot title. Example images of these plots are available in inst/extdata.
